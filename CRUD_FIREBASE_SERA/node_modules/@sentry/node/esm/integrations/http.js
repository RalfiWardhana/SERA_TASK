...
import { parseSemver, logger, dynamicSamplingContextToSentryBaggageHeader, fill, isMatchingPattern } from '@sentry/utils';
      ...
      if (scope && tracingEnabled) {
        ...
        if (parentSpan) {
          ...
          if (shouldAttachTraceData(requestUrl)) {
            var sentryTraceHeader = requestSpan.toTraceparent();
            ...
            if (parentSpan.transaction) {
              var dynamicSamplingContext = parentSpan.transaction.getDynamicSamplingContext();
          ...
          var transaction = parentSpan.transaction;
          if (transaction) {
