...
import { Event, ExtractedNodeRequestData, StackParser } from '@sentry/types';
import { AddRequestDataToEventOptions, CrossPlatformRequest } from '@sentry/utils';
 ...
 * @hidden
 */
export declare function addRequestDataToEvent(event: Event, req: CrossPlatformRequest, options?: Omit<AddRequestDataToEventOptions, 'deps'>): Event;
/**
